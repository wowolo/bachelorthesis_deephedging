...
from nn_model_bs import neural_network
...
class plotting_():  
    ...
    def __init__(self, num_epsilons, L, num_nodes, num_sub, train_samples):
        """
        ...
        """
        self.num_epsilons=num_epsilons; self.L=L; self.num_nodes=num_nodes; self.num_sub=num_sub; self.train_samples=train_samples
    ...
    def computation(self):
        ...
        for i, eps in enumerate(epsilons):
            ...
            NN_model = neural_network(eps, self.L, self.num_nodes, self.num_sub, self.train_samples)
